<?php
    ...
    class savingTotal_CO
    {
        ...
        function updateSaving($pers_id,$saving_value,$sato_month,$updated_at)
        {
            ...
            if($month>$curren_month)
            {
                ...
                $savingTotal_MO->updateSavingWithOutMonth($pers_id,$total,$updated_at);
            }
            else
            {
                $conexion =new conexion("all");
                ...
                $savingTotal_MO->updateSaving($pers_id,$total,$sato_month,$updated_at);
            }
